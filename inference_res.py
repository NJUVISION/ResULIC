...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--output", type=str, default='results_win_res_15/', help="Root directory for reconstructed images, residual results, bitstreams, and metric json files.")
    ...
    parser.add_argument("--Q",type=float,default=4,help="Label for the trained lambda/Q setting, used only in output folder and json paths. NOTE: this does not affect test results in this script.")
