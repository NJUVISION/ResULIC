...
def decode_ids(input_ids, tokenizer, by_token=False):
    ...
    return texts
# @torch.no_grad()
def process(model, imgs, img, args, sampler, steps, stream_path, prompt, clip_model, clip_preprocess):
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--output", type=str, default='result_3/', help="Path to save results")
    parser.add_argument("--ddim_steps",type=int,default=2,help="number of ddim sampling steps",)
    parser.add_argument("--ddim_eta",type=float,default=0.0,help="ddim eta (eta=0.0 corresponds to deterministic sampling",)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--device", type=str, default="cuda", choices=["cpu", "cuda"])
    parser.add_argument("--Q",type=float,default=1.0,help="")
    parser.add_argument("--add_steps",type=int,default=100,help="")
